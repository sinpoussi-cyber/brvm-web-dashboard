...
// Import company types first, then re-export them
import type {
  Company as CompanyBase,
  CompanyDetail as CompanyDetailBase,
  Sector as SectorBase,
  ComparableCompany as ComparableCompanyBase,
  ComparableCompaniesResponse as ComparableCompaniesResponseBase,
} from './company';

// Re-export company types so they're available from @/types/api
export type Company = CompanyBase;
export type CompanyDetail = CompanyDetailBase;
export type Sector = SectorBase;
export type ComparableCompany = ComparableCompanyBase;
export type ComparableCompaniesResponse = ComparableCompaniesResponseBase;
